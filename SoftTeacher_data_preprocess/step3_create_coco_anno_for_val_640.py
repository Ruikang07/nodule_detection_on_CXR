...
root_dir = 'data/coco'
meta_file = os.path.join(root_dir, 'val.csv')
img_dir = os.path.join(root_dir, 'val2017')
anno_dir = os.path.join(root_dir, 'annotations')
if not os.path.exists(anno_dir):
    os.makedirs(anno_dir)
    
anno_json_file = os.path.join(anno_dir, 'instances_val2017.json')
txt_file = os.path.join(root_dir,'nodule_val_img_list.txt')
